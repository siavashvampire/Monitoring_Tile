...
class electrical extends innerController
{
    ...
    private static function insertLog($_data): array
    {
        ...
        $key[] = 'Active_Power_Present_Demand';
        $key[] = 'Active_Power_Predicted_Demand';
        $key[] = 'Active_Power_Peak_Demand';
        $key[] = 'Active_Power_PK_DT_Demand';
        $key[] = 'Reactive_Power_Last_Demand';
        $key[] = 'Reactive_Power_Present_Demand';
        $key[] = 'Reactive_Power_Predicted_Demand';
        $key[] = 'Reactive_Power_Peak_Demand';
        $key[] = 'Reactive_Power_PK_DT_Demand';
        $key[] = 'Apparent_Power_Last_Demand';
        $key[] = 'Apparent_Power_Present_Demand';
        $key[] = 'Apparent_Power_Predicted_Demand';
        $key[] = 'Apparent_Power_Peak_Demand';
        $key[] = 'Apparent_Power_PK_DT_Demand';
        ...
        $log->setActivePowerPresentDemand($data['Active_Power_Present_Demand']);
        $log->setActivePowerPredictedDemand($data['Active_Power_Predicted_Demand']);
        $log->setActivePowerPeakDemand($data['Active_Power_Peak_Demand']);
        $log->setActivePowerPKDTDemand($data['Active_Power_PK_DT_Demand']);
        ...
        $log->setReactivePowerPresentDemand($data['Reactive_Power_Present_Demand']);
        $log->setReactivePowerPredictedDemand($data['Reactive_Power_Predicted_Demand']);
        $log->setReactivePowerPeakDemand($data['Reactive_Power_Peak_Demand']);
        $log->setReactivePowerPKDTDemand($data['Reactive_Power_PK_DT_Demand']);
        ...
        $log->setApparentPowerPresentDemand($data['Apparent_Power_Present_Demand']);
        $log->setApparentPowerPredictedDemand($data['Apparent_Power_Predicted_Demand']);
        $log->setApparentPowerPeakDemand($data['Apparent_Power_Peak_Demand']);
        $log->setApparentPowerPKDTDemand($data['Apparent_Power_PK_DT_Demand']);
