...
return [
    ...
    'db' => [
        ...
        'elecsub_data' => [
            'fields' => [
                ...
                'Current_Unbalance_A' => "FLOAT NULL DEFAULT NULL",
                'Current_Unbalance_B' => "FLOAT NULL DEFAULT NULL",
                'Current_Unbalance_C' => "FLOAT NULL DEFAULT NULL",
                'Current_Unbalance_Worst' => "FLOAT NULL DEFAULT NULL",
                ...
                'Voltage_Unbalance_A_B' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_B_C' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_C_A' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_L_L_Worst' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_A_N' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_B_N' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_C_N' => "FLOAT NULL DEFAULT NULL",
                'Voltage_Unbalance_L_N_Worst' => "FLOAT NULL DEFAULT NULL",
                ...
                'Power_Factor_Total_IEEE' => "FLOAT NULL DEFAULT NULL",
                'Active_Energy_Delivered_Into_Load' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Received_Out_of_Load' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Delivered_Pos_Received' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Delivered_Neg_Received' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Received' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Pos_Received' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Neg_Received' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Received' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered_Pos_Received' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered_Neg_Received' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_in_Quadrant_I' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_in_Quadrant_II' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_in_Quadrant_III' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_in_Quadrant_IV' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Delivered_Into_Load_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Received_Out_of_Load_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Delivered_Pos_Received_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Active_Energy_Delivered_Neg_Received_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Received_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Pos_Received_Permanent' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Neg_Received_Permanent' => "INT(11) NULL DEFAULT NULL",
                ...
                'Reactive_Energy_Delivered_Phase_A' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Phase_B' => "INT(11) NULL DEFAULT NULL",
                'Reactive_Energy_Delivered_Phase_C' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered_Phase_A' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered_Phase_B' => "INT(11) NULL DEFAULT NULL",
                'Apparent_Energy_Delivered_Phase_C' => "INT(11) NULL DEFAULT NULL",
            ],
            'KEY' => [
                'substation_id',
            ],
    ...
    'sqlInstall' => [
        ...
        "INSERT IGNORE INTO `{prefix}substation_devicetype` (`id`, `label`) VALUES (2, 'Schneider_PM2200');",
