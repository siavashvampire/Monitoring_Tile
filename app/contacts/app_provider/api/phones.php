...
class phones extends innerController {
    public  static function Items() {
        return self::json( parent::model( ['contacts', 'phone'] )->getItems());
    }
    public  static function SmsItems () {
        return self::json( parent::model( ['contacts', 'phone'] )->getSmsItems());
    }
    public  static function BaleItems() {
        return self::json( parent::model( ['contacts', 'phone'] )->getBaleItems());
    }
}