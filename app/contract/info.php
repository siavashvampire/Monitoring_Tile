    ...
    'db' => [
        'vote' => [
            'fields' => [
                ...
                'voteName' => "varchar(65) COLLATE utf8_persian_ci NOT NULL",
                'voteReceiver' => "int(11) DEFAULT NULL",
                'contractGroup' => "int(11) DEFAULT NULL",
            ...
            'REFERENCES' => [
                'voteReceiver' => ['table' => 'user_group', 'column' => 'user_groupId', 'on_delete' => 'CASCADE', 'on_update' => 'CASCADE'],
                'contractGroup' => ['table' => 'user_group', 'column' => 'user_groupId', 'on_delete' => 'CASCADE', 'on_update' => 'CASCADE']
            ]
        ],
        'evaluation_type' => [
            'fields' => [
        ...
        'evaluation_data' => [
            ...
            'REFERENCES' => [
                ...
                'type' => ['table' => 'evaluation_type', 'column' => 'id', 'on_delete' => 'CASCADE', 'on_update' => 'CASCADE'],
            ]
        ],
        'contracts' => [
            'fields' => [
            ...
            'REFERENCES' => [
                'userId' => ['table' => 'user', 'column' => 'userId', 'on_delete' => 'RESTRICT', 'on_update' => 'CASCADE'],
                'contractor' => ['table' => 'user', 'column' => 'userId', 'on_delete' => 'RESTRICT', 'on_update' => 'CASCADE'],
                'contractGroup' => ['table' => 'user_group', 'column' => 'user_groupId', 'on_delete' => 'CASCADE', 'on_update' => 'CASCADE']
            ]
        ],
        'contracts_vote' => [
            'fields' => [
                'fillOutId' => 'INT(11) NOT NULL AUTO_INCREMENT',
            ...
            'REFERENCES' => [
                'userId' => ['table' => 'user', 'column' => 'userId', 'on_delete' => 'RESTRICT', 'on_update' => 'CASCADE'],
                'contractId' => ['table' => 'contracts', 'column' => 'contractId', 'on_delete' => 'RESTRICT', 'on_update' => 'CASCADE'],
                'voteId' => ['table' => 'vote', 'column' => 'voteId', 'on_delete' => 'CASCADE', 'on_update' => 'CASCADE']
            ]
        ],
    ],
    'sqlInstall' => [
