...
class invoice extends controller {
	...
	public function callBack($base64InvoiceId){
		...
		$invoice = \App\invoice\app_provider\api\invoice::checkTransAction($transaction);
		if ( $invoice['result']['backUri'] != '' and $invoice['result']['status'] == 'paid')
			Response::redirect($invoice['result']['backUri']);
		else
