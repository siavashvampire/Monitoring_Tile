...
class carton_size extends controller
{
    private $item_label = "سایز کارتون";
    private $log_name = 'carton_size';
    private $model_name = 'carton_size';
    private $controller_name = 'carton_size';
    private $app_name = 'product';
    private $active_menu = 'carton_size';
    private $html_file_path = 'carton_size.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\carton_size $model */
