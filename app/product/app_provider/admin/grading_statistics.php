...
class grading_statistics extends controller
{
    private $item_label = "آمار درجهبندی";
    private $log_name = 'grading_statistics';
    private $model_name = 'grading_statistics';
    private $controller_name = 'grading_statistics';
    private $app_name = 'product';
    private $active_menu = 'grading_statistics';
    private $html_file_path = 'grading_statistics';
