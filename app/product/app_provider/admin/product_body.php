...
class product_body extends controller
{
    private $item_label = "بدنه";
    private $model_name = 'product_body';
    private $controller_name = 'product_body';
    private $log_name = 'product_body';
    private $app_name = 'product';
    private $active_menu = 'product_body';
    private $html_file_path = 'product_body.mold.html';
