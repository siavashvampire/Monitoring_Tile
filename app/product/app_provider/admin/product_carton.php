...
class product_carton extends controller
{
    private $item_label = "کارتون";
    private $model_name = 'product_carton';
    private $controller_name = 'product_carton';
    private $log_name = 'product_carton';
    private $app_name = 'product';
    private $active_menu = 'product_carton';
    private $html_file_path = 'product_carton.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_carton $model */
    ...
    {
        /* @var \App\product\model\product_carton $model */
        $get = request::post('id,label,carton_theme,carton_weight,carton_size');
        $rules = [
        ...
        $model->setCartonTheme($get['carton_theme']);
        $model->setCartonWeight($get['carton_weight']);
        $model->setCartonSize($get['carton_size']);
