...
class product_carton_packing extends controller
{
    private $item_label = "نوع بسته بندی کارتون";
    private $model_name = 'product_carton_packing';
    private $controller_name = 'product_carton_packing';
    private $log_name = 'product_carton_packing';
    private $app_name = 'product';
    private $active_menu = 'product_carton_packing';
    private $html_file_path = 'product_carton_packing.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_carton_packing $model */
