...
class product_complementary_printing_before_digital extends controller
{
    private $item_label = "چاپ مکمل قبل از دیجیتال";
    private $model_name = 'product_complementary_printing_before_digital';
    private $controller_name = 'product_complementary_printing_before_digital';
    private $log_name = 'product_complementary_printing_before_digital';
    private $app_name = 'product';
    private $active_menu = 'product_complementary_printing_before_digital';
    private $html_file_path = 'product_complementary_printing_before_digital.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_complementary_printing_before_digital $model */
