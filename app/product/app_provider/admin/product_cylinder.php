...
class product_cylinder extends controller
{
    private $item_label = "سیلندر";
    private $model_name = 'product_cylinder';
    private $controller_name = 'product_cylinder';
    private $log_name = 'product_cylinder';
    private $app_name = 'product';
    private $active_menu = 'product_cylinder';
    private $html_file_path = 'product_cylinder.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_cylinder $model */
