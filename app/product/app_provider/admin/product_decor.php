...
class product_decor extends controller
{
    private $item_label = "دکور";
    private $model_name = 'product_decor';
    private $controller_name = 'product_decor';
    private $log_name = 'product_decor';
    private $app_name = 'product';
    private $active_menu = 'product_decor';
    private $html_file_path = 'product_decor.mold.html';
