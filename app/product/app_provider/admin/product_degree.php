...
class product_degree extends controller
{
    private $item_label = "درجه";
    private $model_name = 'product_degree';
    private $controller_name = 'product_degree';
    private $log_name = 'product_degree';
