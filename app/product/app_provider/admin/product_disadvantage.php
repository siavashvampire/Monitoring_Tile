...
class product_disadvantage extends controller
{
    private $item_label = "معایب";
    private $model_name = 'product_disadvantage';
    private $controller_name = 'product_disadvantage';
    private $log_name = 'product_disadvantage';
    private $app_name = 'product';
    private $active_menu = 'product_disadvantage';
    private $html_file_path = 'product_disadvantage.mold.html';
