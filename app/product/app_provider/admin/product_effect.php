...
class product_effect extends controller
{
    private $item_label = "افکت";
    private $model_name = 'product_effect';
    private $controller_name = 'product_effect';
    private $log_name = 'product_effect';
    private $app_name = 'product';
    private $active_menu = 'product_effect';
    private $html_file_path = 'product_effect.mold.html';
