...
class product_engobe extends controller
{
    ...
    private $controller_name = 'product_engobe';
    private $log_name = 'product_engobe';
    private $app_name = 'product';
    private $active_menu = 'product_engobe';
    private $html_file_path = 'product_engobe.mold.html';
