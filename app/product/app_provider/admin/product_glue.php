...
class product_glue extends controller
{
    private $item_label = "چسب";
    private $model_name = 'product_glue';
    private $controller_name = 'product_glue';
    private $log_name = 'product_glue';
    private $app_name = 'product';
    private $active_menu = 'product_glue';
    private $html_file_path = 'product_glue.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_glue $model */
