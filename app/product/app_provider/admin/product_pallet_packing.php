...
class product_pallet_packing extends controller
{
    private $item_label = "نوع بسته بندی پالت";
    private $model_name = 'product_pallet_packing';
    private $controller_name = 'product_pallet_packing';
    private $log_name = 'product_pallet_packing';
    private $app_name = 'product';
    private $active_menu = 'product_pallet_packing';
    private $html_file_path = 'product_pallet_packing.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_pallet_packing $model */
    ...
    {
        /* @var \App\product\model\product_pallet_packing $model */
        $get = request::post('id,label,carton,pallet,strap,plastic,plastic_weight,strap_weight,carton_on_pallet');
        $rules = [
        ...
        $model->setCarton($get['carton']);
        $model->setPallet($get['pallet']);
        $model->setStrap($get['strap']);
        $model->setPlastic($get['plastic']);
        $model->setPlasticWeight($get['plastic_weight']);
        $model->setStrapWeight($get['strap_weight']);
        $model->setCartonOnPallet($get['carton_on_pallet']);
