...
class product_plastic extends controller
{
    private $item_label = "پلاستیک";
    private $model_name = 'product_plastic';
    private $controller_name = 'product_plastic';
    private $log_name = 'product_plastic';
    private $app_name = 'product';
    private $active_menu = 'product_plastic';
    private $html_file_path = 'product_plastic.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_plastic $model */
