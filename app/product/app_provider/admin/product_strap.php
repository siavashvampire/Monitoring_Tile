...
class product_strap extends controller
{
    private $item_label = "تسمه";
    private $model_name = 'product_strap';
    private $controller_name = 'product_strap';
    private $log_name = 'product_strap';
    private $app_name = 'product';
    private $active_menu = 'product_strap';
    private $html_file_path = 'product_strap.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_strap $model */
