...
class product_sub_engobe extends controller
{
    private $item_label = "زیر انگوب";
    private $model_name = 'product_sub_engobe';
    private $controller_name = 'product_sub_engobe';
    private $log_name = 'product_sub_engobe';
    private $app_name = 'product';
    private $active_menu = 'product_sub_engobe';
    private $html_file_path = 'product_sub_engobe.mold.html';

    public function index(): bool
    {
        /* @var \App\product\model\product_sub_engobe $model */
