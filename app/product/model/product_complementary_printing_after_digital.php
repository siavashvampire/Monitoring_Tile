...
class product_complementary_printing_after_digital extends model implements modelInterFace {
    private $tableName = "product_complementary_printing_after_digital";
