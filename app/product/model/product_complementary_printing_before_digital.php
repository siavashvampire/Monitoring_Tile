...
class product_complementary_printing_before_digital extends model implements modelInterFace {
    private $tableName = "product_complementary_printing_before_digital";
