...
{
    public static function index($date = null): array
    {
        ...
        /** @var shift_time $model */
        $model = parent::model(['shiftWork', 'shift_time']);
