...
return [
	...
	'db' => [
		'user_group' => [
			'fields' => [
				...
				'contractTemplate' => "LONGTEXT NULL DEFAULT NULL",
			],
			'KEY' => [
			],
			'PRIMARY KEY' => [
		...
		'user' => [
			'fields' => [
				...
				'password' => "varchar(65) COLLATE utf8_persian_ci DEFAULT NULL",
    ...
    'sqlInstall' => [
        "INSERT IGNORE INTO `{prefix}user`(`userId`, `fname`, `lname`, `email`, `phone`, `block`, `verified`, `admin_note`, `password`, `user_group_id`) VALUES (-1,'ذخیره ساز','ذخیره ساز',null ,null ,0,0,null ,null,1);",
    ]
];