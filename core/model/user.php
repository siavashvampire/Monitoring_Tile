...
class user extends model implements modelInterFace
{
    ...
    private $primaryKeyShouldNotInsertOrUpdate = ['ID:userId', 'avatarLink'];
    private $userId;
    private $fname;
    private $lname;
    private $email;
    ...
    public function setFromArray($result)
    {
        ...
        $this->avatarLink = $this->avatarDirectoryUrl . $result['userId'];
    }

    public function __construct($searchVariable = null, $searchWhereClaus = '___MODEL_ID_GENERATOR___')
    {
        $this->avatarDirectoryUrl = app::getBaseAppLink('access/showAvatar', 'user');
        parent::__construct($searchVariable, $searchWhereClaus);
    }
    ...
    public function returnAsArray()
    {
        ...
        $array['avatarLink'] = $this->avatarLink;
        return $array;
    }
     ...
     * @return string
     */
    public function getAvatarLink($userId = null)
    {
        if ($userId == null)
            $userId = $this->getUserId();
        return $this->avatarDirectoryUrl . $userId;
    }

    public function getUsers($value = array(), $variable = array(),$order = ['column' => 'item.userId', 'type' => 'asc'])
    {
        $table = 'user item';
        return parent::search($value, ( count($variable) == 0 ) ? null : implode(' and ' , $variable) ,$table , 'item.*');
    }
