...
require_once(__DIR__.'/includes/tcpdf_font_data.php');
// TCPDF static font methods and data
require_once(__DIR__.'/includes/tcpdf_fonts.php');
// TCPDF static color methods and data
require_once(__DIR__.'/includes/tcpdf_colors.php');
// TCPDF static image methods and data
require_once(__DIR__.'/includes/tcpdf_images.php');
// TCPDF static methods and data
require_once(__DIR__.'/includes/tcpdf_static.php');
...
//			$name = preg_replace('/[^a-zA-Z0-9_\.-]/', '', $name);
	...
	protected function _putcatalog() {
		...
		if ($this->pdfa_mode OR $this->force_srgb) {
			$iccobj = $this->_newobj();
			$icc = file_get_contents(__DIR__ . '/includes/sRGB.icc');
			$filter = '';
			if ($this->compress) {
				$filter = ' /Filter /FlateDecode';
				$icc = gzcompress($icc);
