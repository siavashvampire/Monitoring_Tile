  ...
  function process($user,$msg){
    ...
    //$this->say("< ".$msg);
	  ...
	  foreach($this->users as $u)
		  $this->send($u->socket,$msg."\0");


	  switch($msg){
	  case "ping" :  $this->send($user->socket,"pong\0"); break; //heartbeat frame reply with pong
      case "hello" : $this->send($user->socket,"hello human\0");                       break;
      ...
      case "thanks": $this->send($user->socket,"you're welcome\0");                    break;
